  ...
  return (
    <div>
      <input
        ...
        className="w-full rounded-md border border-border bg-surface px-3 py-2 text-sm text-white outline-none"
      />
      {loading && <p className="mt-1 text-xs text-neutral-500">Aranıyor…</p>}
      {results.length > 0 && (
